...
class Term(_coconut.typing.NamedTuple("Term", [("name", 'str'), ("args", '_coconut.typing.Any')]), _coconut.object):
    __slots__ = ()
    ...
    def __repr__(self):
        return "Term(name={name!r}, *args={args!r})".format(**self._asdict())
...
class Context(_coconut.collections.namedtuple("Context", ""), _coconut.object):
    __slots__ = ()
    __ne__ = _coconut.object.__ne__
    def __eq__(self, other):
        return self.__class__ is other.__class__ and _coconut.tuple.__eq__(self, other)
...
class Rexpr(_coconut.collections.namedtuple("Rexpr", ""), Term):
    __slots__ = ()
    __ne__ = _coconut.object.__ne__
    def __eq__(self, other):
        return self.__class__ is other.__class__ and _coconut.tuple.__eq__(self, other)
...
def is_ground(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    _coconut_FunctionMatchError = _coconut_get_function_match_error()
    if (_coconut.len(_coconut_match_to_args) == 2) and ("ctx" not in _coconut_match_to_kwargs) and (_coconut.isinstance(_coconut_match_to_args[1], Term)) and (_coconut.len(_coconut_match_to_args[1]) == 2) and (_coconut_match_to_args[1][0] == '$VARIABLE'):
        _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("ctx")
        x = _coconut_match_to_args[1][1]
        if not _coconut_match_to_kwargs:
            ctx = _coconut_match_temp_0
            _coconut_match_check = True
    if not _coconut_match_check:
        raise _coconut_FunctionMatchError("def is_ground(ctx, Term('$VARIABLE', x)) = False", _coconut_match_to_args)

    return False
@_coconut_addpattern(is_ground)
@_coconut_mark_as_match
def is_ground(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    _coconut_FunctionMatchError = _coconut_get_function_match_error()
    if (_coconut.len(_coconut_match_to_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 0, "ctx" in _coconut_match_to_kwargs)) == 1) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 1, "t" in _coconut_match_to_kwargs)) == 1):
        _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("ctx")
        _coconut_match_temp_1 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("t")
        if not _coconut_match_to_kwargs:
            ctx = _coconut_match_temp_0
            t = _coconut_match_temp_1
            _coconut_match_check = True
    if not _coconut_match_check:
        raise _coconut_FunctionMatchError('addpattern def is_ground(ctx, t) = True', _coconut_match_to_args)
...
def factorial(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    ...
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut_match_to_args[0] == 0):
        if not _coconut_match_to_kwargs:
            _coconut_match_check = True
    if not _coconut_match_check:
        raise _coconut_FunctionMatchError('def factorial(0) = 1', _coconut_match_to_args)

    return 1
@_coconut_addpattern(factorial)
@_coconut_mark_as_match
def factorial(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    _coconut_FunctionMatchError = _coconut_get_function_match_error()
    ...
    if _coconut_match_check and not (n > 0):
        _coconut_match_check = False
    if not _coconut_match_check:
        raise _coconut_FunctionMatchError('addpattern def factorial(n is int if n > 0) = factorial(n-1)*n', _coconut_match_to_args)
